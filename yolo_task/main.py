...
def main():
    ...
    train_dataset = COCODataset("bbox_labels_test.json", S=S, C=C, B=B, transform=transform, img_dir=TRAIN_IMG_DIR, label_dir=LABEL_DIR)
    ...
    val_dataset = COCODataset("bbox_labels_test.json", S=S, C=C, B=B, transform=transform, img_dir=TRAIN_IMG_DIR, label_dir=LABEL_DIR)
